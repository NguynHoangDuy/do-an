import { getListTG } from "./getListPhong.js";
    ...
    success: function (classes) {
      ...
      if (classes.length !== 0) {
        ...
        classes.forEach((item) => {
          ...
          html += `<td> <a data-toggle="modal" data-target= '#tkb${item.MA_LOP}' data-malop="${item.MA_LOP}" data-magv="${item.MA_GV} class="btn btn-primary btn-sm tkb-btn"><i class="fa fa-info-circle"></i> </a></td>`;
          ...
          <div class="modal-dialog mw-70" role="document">
            <div class="modal-content">
              <form action="/admin/modangky/modangky" method="post">
                ...
                <div class="flex flex-end"><a class="button them-tkb-btn" data-malop="${item.MA_LOP}" data-magv="${item.MA_GV}" data-macn="${item.MA_CHI_NHANH}" data-toggle="modal" data-target="#themtkb-modal">Thêm thời khóa biểu</a></div>
